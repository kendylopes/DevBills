  ...
  const features: ReadonlyArray<Feature>=[
    {
      ...
      description: "Monitore suas despesas e receitas em um só lugar, com uma inteface intuitiva e fácil de usar",
    },
    {
    ...
    },
    {
      ...
      description: "Organize suas transações em categorias para melhor analise",
    },
    {
      icon: <CreditCard className="w-8 h-8 text-primary-500" />,
      title: "Transações Ilimitadas",
      description: "Adicione quantas transações quiser e matenha um historico completo de suas finanças.",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-lg text-white mb-8">
                ...
                suas finanças pessoais ou do seu négocio com facilidade. 
              </p>
        ...
        <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
          <div className="container-app">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">Recursos DevBills</h2>
